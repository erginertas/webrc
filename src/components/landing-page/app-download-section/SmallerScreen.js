                    ...
                    >
                        <CustomStackFullWidth spacing={1}>
                            <Typography variant="h4" color="primary.main">
                                <DollarSignHighlighter theme={theme} text={landingPageData?.business_title} />
                            </Typography>
                            <Typography variant="h4" color="primary.main">
                                <DollarSignHighlighter theme={theme} text={landingPageData?.business_sub_title} />
                            </Typography>
                        </CustomStackFullWidth>
                        <CustomStackFullWidth spacing={2}>
                            {
                                landingPageData?.download_business_app_links && <CustomStackFullWidth
                                    gap={{xs:2, sm:4}}
                                    direction="row"
                                    flexGrow={1}
                                    flexWrap="wrap"
                                ...
                                >
                                    {
                                        (landingPageData?.download_business_app_links?.seller_playstore_url_status === '1' || landingPageData?.download_business_app_links?.seller_appstore_url_status === '1') &&
                                        <CustomButtonComponent t={t} landingPageData={landingPageData} title={t('Seller App')}
                                                               urls={{
                                    ...
                                    {
                                        ( landingPageData?.download_business_app_links?.dm_playstore_url_status === '1' ||  landingPageData?.download_business_app_links?.dm_appstore_url_status === '1') &&
                                        <CustomButtonComponent t={t} landingPageData={landingPageData} title={t('Deliveryman App')}
                                                               urls={{
