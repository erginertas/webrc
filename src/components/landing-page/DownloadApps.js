        ...
        return (
            ...
            >
                <Typography textAlign="flex-start" variant={isSmall ? "h7" : "h5"}>
                    <DollarSignHighlighter theme={theme} text={landingPageData?.download_user_app_title}/>
                </Typography>
                <Typography
                    ...
                    sx={{mt: "10px"}}
                >
                    <DollarSignHighlighter theme={theme} text={landingPageData?.download_user_app_sub_title}/>
                </Typography>
