...
import {alpha, Button, Grid, styled, Typography, useMediaQuery, useTheme,} from "@mui/material";
                            ...
                            >
                                <CustomStackFullWidth>
                                    <Typography
                                        ...
                                        color="primary.main"
                                    >
                                        <DollarSignHighlighter theme={theme} text={landingPageData?.company_title} />
                                    </Typography>
                                    <Typography variant={isSmall ? "h6" : "h4"}>
                                        <DollarSignHighlighter theme={theme} text={landingPageData?.company_sub_title} />
                                    </Typography>
                                </CustomStackFullWidth>
                                <Typography
                                ...
                                >
                                    <DollarSignHighlighter theme={theme} text={landingPageData?.company_description} />
                                </Typography>
                                <CustomStackFullWidth
