...
import {Alert, Grid, IconButton, Paper, Skeleton, styled, Typography, useMediaQuery, useTheme,} from "@mui/material";
...
import {module_bottom, module_header,} from "../../../../utils/toasterMessages";
...
export const ModuleSelection = ({
    ...
    const innerContent = () => {
        if (isFetched) {
            if (data?.length === 0) {
                ...
                >
                    <CustomPaper sx={{position: 'relative'}}>
                        ...
                        <CustomStackFullWidth alignItems='center' justifyContent='center' spacing={{xs: 2, sm: 2}}>
            ...
            return <CustomModal openModal={openModal}
                                handleClose={handleCloseModal}>
                <CustomPaper><Grid container spacing={isXSmall ? 0.5 : 2}>
                    <Shimmer/>
                </Grid></CustomPaper>
            </CustomModal>
        }
