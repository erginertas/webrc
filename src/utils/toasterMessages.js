...
export const cart_clear_description ="You have item from another store in cart. If you continue, your all previous item from cart will be removed and this one will be added."
...
export const coupon_minimum='To apply this coupon, total item amount should be minimum'
